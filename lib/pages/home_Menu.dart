...
import 'JoinReservation.dart';
import 'ReservationList.dart';
import 'SportDateSelection.dart';
  ...
  Widget getGridView() {
    return GridView.count(
      ...
      children: <Widget>[
        ...
        createTile(0, _selectedIndex, false, 'Effettua Prenotazione',
            Colors.purple, Icons.sports_football),
        createTile(1, _selectedIndex, true, 'Visualizza Prenotazione',
            Colors.orange, Icons.local_activity),
        createTile(2, _selectedIndex, false, 'Unisciti alla Prenotazione',
            Colors.red, Icons.app_settings_alt),
      ],
    );
  }
      ...
      child: Container(
        ...
        child: GestureDetector(
          onTap: () async {
            ...
            if (_selectedIndex == 2) {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => Partecipa()));
            }
