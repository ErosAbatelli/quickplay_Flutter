...
import 'package:quickplay/utils/customDropDownMenu/remove_over_scroll.dart';
...
class AwesomeDropDown extends StatefulWidget {
  ...
  AwesomeDropDown({
    ...
    this.dropDownBottomBorderRadius: 20,
    this.dropDownTopBorderRadius: 20,
    this.selectedItem: '',
...
class _AwesomeDropDownState extends State<AwesomeDropDown>  with WidgetsBindingObserver
{
  ...
  Widget build(BuildContext context) {
    if (widget.isBackPressedOrTouchedOutSide != null &&
        widget.isBackPressedOrTouchedOutSide && _isDropdownOpened)
    {
      _openAndCloseDrawer();
  ...
  OverlayEntry _createFloatingDropdown(int numOfListItemToShow) {
    ...
    return OverlayEntry(builder: (context) {
      return Positioned(
        left: _gestureDetectorXPosition * 1.0,
...
class DropDownOverlay extends StatelessWidget {
  ...
  DropDownOverlay(
      {Key key,
      this.itemHeight = 0.0, this.dropDownList,
      this.overlayBGColor: Colors.white, this.dropDownItemClick,
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                padding: EdgeInsets.only(
                                    left: 7, right: 8, top: 4, bottom: 10),
                                child: Text(
                                  x,
